...
function CreateIncomes({ refreshData }) {
  ...
  const [reciveddate, setReceivedDate] = useState("");
  ...
  const onCreateIncomes = async () => {
    const result = await db
      ...
      .values({
        name: name,
        amount: amount,
        reciveddate: new Date(reciveddate),
            ...
            <DialogDescription>
              <div className="mt-5">
                ...
                <div className="mt-2">
                  ...
                  <Input
                    type="number"
                    placeholder="e.g. NPR 10000"
                    onChange={(e) => setAmount(e.target.value)}
                  />
                </div>
                <div className="mt-2">
                <h2 className="text-black font-medium my-1">Received Date</h2>
                <Input
                  type="date"
                  value={reciveddate}
